            ...
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p class="animate__animated animate__fadeInUp">No hay personas mejores que aquellas a quienes les encanta la buena comida.<div>
                  <a href="./register_user.jsp" class="btn-menu animate__animated animate__fadeInUp scrollto">Registrarse</a>
                  <a href="./login.jsp" class="btn-book animate__animated animate__fadeInUp scrollto">Iniciar sesion</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch">
            ...
            <div class="content">
              <h3>Todo empezo <strong>con una ilusion... </strong></h3>
              <p>
              Un dia Albert cito a su amigo Javier para comentarle que queria abrir un restaurante, una de esas asignaturas pendientes. Para ello necesitaba un socio en el que confiase ciegamente y alli en un sofa de su casa, cerveza en mano, se empezo a forjar la idea.
              </p>
              <p class="font-italic">
                No tardaron en empezar a hablar de una de sus pasiones, la cocina, e hicieron un recorrido por los mejores restaurantes de Arequipa y llegaron a una conclusion: no hay platos que traten su producto desde un punto de vista estrictamente "Delicious". Lo que podian ofrecer era:
              </p>
              <ul>
                <li><i class="bx bx-check-double"></i> Entradas Delicious.</li>
                <li><i class="bx bx-check-double"></i> Platos principales Delicious.</li>
                <li><i class="bx bx-check-double"></i> Extras Delicious.</li>
              </ul>
              <p>
